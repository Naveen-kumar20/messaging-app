...
const Sidebar = () => {
  ...
  //this is used to filter the users based 'Online users checkbox' to show only online users or not.
          ...
          >
            <div className='relative mx-auto lg:mx-0'>
              ...
              {onlineUsers.includes(user._id) && (
                <span
                  className='absolute bottom-0 right-0 bg-green-500 size-3 rounded-full ring-2 ring-zinc-900'
                />
              )}
            </div>
